...
6. [Simulation Flow (Makefile)](#simulation-flow-makefile)
7. [Python Testbench Architecture](#python-testbench-architecture)
8. [Register Abstraction Layer (RAL)](#register-abstraction-layer-ral)
9. [Coverage Strategy](#coverage-strategy)
10. [Randomization Strategy](#randomization-strategy)
11. [Trade-offs: SV vs. Python Testbenches](#trade-offs-sv-vs-python-testbenches)
12. [Future Migration Possibilities](#future-migration-possibilities)
